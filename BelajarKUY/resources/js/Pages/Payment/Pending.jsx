...
export default function PaymentPending({ payment }) {
    return (
        <>
            <Head title="Menunggu Pembayaran — BelajarKUY" />
            <div className="bg-background text-on-background flex flex-col min-h-screen font-sans antialiased">
                ...
                <main className="flex-grow flex items-center justify-center p-margin-mobile md:p-margin-desktop">
                    ...
                    >
                        ...
                        <div className="w-24 h-24 bg-warning/10 rounded-full flex items-center justify-center mb-lg relative">
                            <div className="absolute inset-0 bg-warning/20 rounded-full animate-ping opacity-75" />
                            <Clock className="w-12 h-12 text-warning relative z-10" />
                        </div>
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant mb-xl">
                            Pesanan kamu sudah dibuat. Selesaikan pembayaran sesuai metode yang dipilih sebelum batas waktu berakhir agar kursus langsung aktif.
                        </p>
                        ...
                        {payment && (
                            <div className="w-full bg-surface-container-low rounded-xl p-md mb-xl flex flex-col gap-sm text-left border border-outline-variant/50">
                                ...
                                <div className="flex justify-between items-center pt-sm">
                                    <span className="font-label-md text-label-md text-on-surface">Total Tagihan</span>
